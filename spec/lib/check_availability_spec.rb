...
describe CheckAvailability do
  ...
  let(:member) { create(:membership, user_id: user.id, billable: true, ends_at: Date.today, project: project) }
  ...
  describe '#available_at?' do
    context 'user who is available now' do
      before do
        ...
        create(:membership, user: sec_user, billable: true, ends_at: 18.day.from_now, project: project)
      end
    ...
    context 'user who is available for 3 weeks' do
      before do
        ...
        create(:membership, user: sec_user, billable: true, ends_at: 36.day.from_now, project: project)
      end
    ...
    context 'user who is available for 1 month' do
      before do
        ...
        create(:membership, user: sec_user, billable: true, ends_at: 46.day.from_now, project: project)
      end
    ...
    context 'user who is available for 2 month' do
      before do
        create(:membership, user: user, billable: true, ends_at: 2.months.from_now, project: project)
        create(:membership, user: sec_user, billable: true, ends_at: 2.months.from_now+15.days, project: project)
      end
